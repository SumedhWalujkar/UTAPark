	...
	<table align="center" cellpadding="5" cellspacing="5" border="1">
		...
		<%
			try {
				...
				String sql = "SELECT parking_Area,Count(parking_Area) from parkingspots where (parking_Area,parking_Number) NOT IN (SELECT parking_Area,parking_Number FROM reservations) AND membership_type='basic' OR membership_type='midrange' OR membership_type='premium' Group by parking_Area;";
		...
		<tr>
  			...
  			<td>
  				...
  				<input type="radio" name="parkings" id="parkings" value="West Garage Floor 1">West Garage Floor 1
  				<input type="radio" name="parkings" id="parkings" value="West Garage Floor 2">West Garage Floor 2
  				<input type="radio" name="parkings" id="parkings" value="West Garage Floor 3">West Garage Floor 3
  				<input type="radio" name="parkings" id="parkings" value="West Garage Floor 4">West Garage Floor 4
