	...
	<table align="center" cellpadding="5" cellspacing="5" border="1">
		...
		<%
			try {
				...
				String sql = "SELECT parking_Area,Count(parking_Area) from parkingspots where (parking_Area,parking_Number) NOT IN (SELECT parking_Area,parking_Number FROM reservations) Group by parking_Area;";
